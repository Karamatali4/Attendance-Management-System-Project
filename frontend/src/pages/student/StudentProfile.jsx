      ...
      <div className="h-[100%] w-[100%] mt-12">
        <div className="md:grid grid-cols-4 grid-rows-2  bg-white gap-2 p-4 rounded-xl">
          ...
          <div className="md:col-span-3 h-auto shadow p-4 space-y-10 mt-10">
            <h2 className="text-cyan-800 font-bold text-3xl">
              
              
              {user.classes && user.classes.slice(0, 5) + " " + user.classes.slice(5)}
            </h2>
            <div className="flex ">
              ...
              <h3 className="px-4 border-l-0 cursor-default border-gray-300 focus:outline-none  rounded-md rounded-l-none shadow-sm -ml-1 w-4/6">
                {user.username}
              </h3>
            </div>
            <div className="flex ">
            ...
            <div className="flex ">
              <span className="text-sm font-bold uppercase border-2 rounded-l px-4 py-2 bg-gray-50 whitespace-no-wrap w-2/5">
                Gender:
              </span>
              <h3 className="px-4 border-l-0 cursor-default border-gray-300 focus:outline-none  rounded-md rounded-l-none shadow-sm -ml-1 w-4/6">
                {user.gender}
